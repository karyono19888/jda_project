        ...
        <nav class="mx-8 mt-8 text-sm lg:mx-20" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                <li class="flex items-center">
                    <a href="#" class="text-gray-400">Buah-Buahan</a>
                    <svg class="w-3 h-3 mx-3 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                        <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                    </svg>
                </li>
                <li class="flex items-center">
                    <a href="#" class="font-medium">Buah Apel Manis</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <div class="grid gap-5 md:grid-cols-12">
            <main class="p-4 lg:col-span-8 md:col-span-12">
                ...
                <div class="details-heading">
                    ...
                    <div class="my-3">
                        @include('components.frontend.rating')
                    </div>
                </div>
                <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                    ...
                    <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                        <div class="flex mt-2 flex-nowrap">
                            <img :class="{'border-4 border-serv-button': active === 1}" @click="changeThumbnail('{{url("https://source.unsplash.com/_SgRNwAVNKw/1600x900/")}}',1)" src="https://source.unsplash.com/_SgRNwAVNKw/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 2}" @click="changeThumbnail('{{url("https://source.unsplash.com/GXNo-OJynTQ/1600x900/")}}',2)" src="https://source.unsplash.com/GXNo-OJynTQ/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 3}" @click="changeThumbnail('{{url("https://source.unsplash.com/x-HpilsdKEk/1600x900/")}}',3)" src="https://source.unsplash.com/x-HpilsdKEk/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 4}" @click="changeThumbnail('{{url("https://source.unsplash.com/hLit2zL-Dhk/1600x900/")}}',4)" src="https://source.unsplash.com/hLit2zL-Dhk/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 5}" @click="changeThumbnail('{{url("https://source.unsplash.com/i1VQZsU86ok/1600x900/")}}',5)" src="https://source.unsplash.com/i1VQZsU86ok/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 6}" @click="changeThumbnail('{{url("https://source.unsplash.com/iEiUITs149M/1600x900/")}}',6)" src="https://source.unsplash.com/iEiUITs149M/250x160/" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        </div>
                    </div>
                </div>
                <div class="content">
                    <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                        ...
                        <div x-show.transition.duration.500ms="tab === 'reviews'">
                            ...
                            @include('components.frontend.review')
                        </div>
                    </div>
                </div>
            </main>
