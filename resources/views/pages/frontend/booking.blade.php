...
@section('content')
    ...
    <section class="w-auto flex min-h-[85vh] pt-6 pb-20 mx-auto lg:mx-12 px-4">
        <div class="m-auto text-center h-auto">
            ...
            <a href="http://wa.me/6287741514500" class="bg-serv-button text-white text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">
                Continue to Chat
            </a>
            <br>
            <a href="/" class="bg-serv-services-bg text-serv-bg text-md font-medium py-4 w-80 my-2 rounded-2xl text-center inline-block">
                Back to Home
            </a>
