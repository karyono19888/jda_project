    ...
    {{-- @else
        <div class="flex h-screen">
            <div class="m-auto text-center">
                ...
                <p class="text-sm text-gray-400">
                    It seems that you haven’t provided any product. <br>
                    Let’s create your first product!
                </p>

                <div class="relative mt-0 md:mt-6">
                    <a href="{{route('member.product.product_create')}}" class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-button">
                        + Add products
                    </a>
                </div>
            </div>
