                        ...
                        <tbody class="bg-white">
                            <tr class="text-gray-700 border-b">
                                ...
                                <td class="px-1 py-5 text-sm">
                                    <a href="{{route('member.order.order_detail',1)}}" class="px-4 py-2 mt-1 mr-2 text-center text-white rounded-xl bg-serv-email">
                                        Details</a>
                                    <a href="{{route('member.order.order_edit',1)}}" class="px-4 py-2 mt-2 text-center text-white rounded-xl bg-serv-email">
                                        Submit
                                    </a>
                                </td>
                            </tr>
