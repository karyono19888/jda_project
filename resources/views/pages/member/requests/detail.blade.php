                        ...
                        <table class="w-full" aria-label="Table">
                            <thead>
                                <tr class="text-sm font-normal text-left text-gray-900 border-b border-b-gray-600">
                                    ...
                                    <th class="py-4" scope="">Product Price</th>
                                    <th class="py-4" scope="">Product Deadline</th>
                                </tr>
                            </thead>
                                ...
                                <div class="p-1 mt-5">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            <label for="note_request" class="block mb-3 font-medium text-gray-700 text-md">Note</label>
                                            <textarea placeholder="Enter your biography here.." type="text" name="note_request" id="note_request" autocomplete="note_request" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">“Hai, aku baru saja mengirim zip file service yang kamu butuhkan. di dalamnya terdapat soft file dan panduan cara menggunakan service ini. terima kasih sudah order. jika butuh sesuatu bisa contact saya di whatsapp”</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="px-1 py-4 text-right">
                                    <a href="{{route('member.request.request_index')}}" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300">
                                        Back
                                    </a>
