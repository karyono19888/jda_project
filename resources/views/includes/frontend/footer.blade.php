        ...
        <div class="sm:flex sm:mt-16">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between">
                <div class="flex-1 mt-2 flex-col">
                    <h2 class="font-medium text-white text-lg mb-4">Perusahaan</h2>
                    <div class="my-3">
                ...
                <div class="flex-1 mt-2 flex-col">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Produk Lokal</h4>
                    <div class="my-3">
                        <a href="#" class="text-serv-text font-light">
                            Sayur-Mayur
                        </a>
                ...
                <div class="flex-1 mt-2 flex-col">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Media Sosial</h4>
                    <div class="my-3">
                        <a href="#" class="text-serv-text font-light">
                            Instagram
                        </a>
                ...
                <div class="flex-1 mt-2 flex-col lg:mr-28">
                    <h4 class="font-medium text-white text-lg mt-4 md:mt-0 mb-4">Informasi &amp; Berita Terbaru</h4>
                    <div class="my-3">
                        <p class="text-serv-text font-light">
                            Berlangganan buletin kami untuk mendapatkan berita mingguan, pembaruan, tip, dan penawaran khusus. Setiap hari Senin!
                        </p>
    ...
    <div class="mx-auto lg:px-16 md:px-20 px-8 py-8 ">
        <div class="mt-16 border-t border-serv-border sm:flex justify-between w-100 ">
            <div class="flex items-left mt-5">
                <img src="{{asset("assets/images/logo.svg")}}" alt="logo class="object-center">
            </div>
            ...
            <div class="flex items-right flex-end mt-8">
                <p class="text-serv-text">
                    &copy; {{date('Y')}} AgroMarket All rights reserved.
                </p>
            </div>
        </div>
    </div>
