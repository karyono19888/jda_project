<a href="/detail" class="inline-block px-3">
    <div class="w-96 h-auto overflow-hidden md:p-5 p-4 bg-white rounded-2xl inline-block">
        <div class="flex items-center space-x-2 mb-6">
            ...
            <div>
                <!--Author name-->
                <p class="text-gray-900 font-semibold text-lg">Mang Adeng</p>
        ...
        <img class="rounded-2xl w-full"
            src="{{url("https://picsum.photos/seed/picsum/750/500")}}" alt="placeholder" />
