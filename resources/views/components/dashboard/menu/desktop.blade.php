        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                @else
                        ...
                        @endphp
                @endif
                <a class="inline-flex items-center w-full text-sm font-{{$font}} text-gray-800 transition-colors duration-150 hover:text-gray-800 " href="{{route('member.index')}}">
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                @else
                    ...
                    @endphp
                @endif
                <a class="inline-flex items-center w-full text-sm font-{{$font}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.product.product_index')}}">
                    @if ( request()->is('member/product')||
                    request()->is('member/product/*')||
                    request()->is('member/*/product')||
                    request()->is('member/*/product/*'))
            ...
            <li class="relative px-6 py-3">
                ...
                @else
                    ...
                    @endphp
                @endif
                <a class="inline-flex items-center w-full text-sm font-{{$font}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.request.request_index')}}">
            ...
            <li class="relative px-6 py-3">
                ...
                @else
                    ...
                    @endphp
                @endif
                <a class="inline-flex items-center w-full text-sm font-{{$font}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.order.order_index')}}">
                    @if (
                        request()->is('member/order')||
                        request()->is('member/order/*')||
                        request()->is('member/*/order')||
            ...
            <li class="relative px-6 py-3">
                ...
                @else
                    ...
                    @endphp
                @endif
                <a class="inline-flex items-center w-full text-sm font-{{$font}} transition-colors duration-150 hover:text-gray-800" href="{{route('member.profile.profile_index')}}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                <form action="{{route('logout')}}" method="POST">
                    @csrf
                    <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{route("logout")}}" onclick="event.preventDefault(); this.closest('form').submit();" >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="24" height="24" fill="white" />
