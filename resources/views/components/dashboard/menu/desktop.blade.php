...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            <div>
                <!--Author name-->
                <p class="font-semibold text-gray-900 text-md">Nama USer</p>
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-medium text-gray-800 transition-colors duration-150 hover:text-gray-800 " href="member/dashboard">
        ...
        <ul>
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="/member/services">
