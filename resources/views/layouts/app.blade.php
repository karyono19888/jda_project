...
<html x-data="data()" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        @stack('before-script-dashboard')

        @include('includes.dashboard.scripts')

        @stack('after-script-dashboard')
    </body>
</html>
